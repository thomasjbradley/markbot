...
window.addEventListener('load', function (ev) {
  // Wait 20ms & 4 animation frames—just to be sure
  setTimeout(function () {
    window.requestAnimationFrame(function () {
      window.requestAnimationFrame(function () {
        window.requestAnimationFrame(function () {
          window.requestAnimationFrame(function () {
            nodeRequire('electron').ipcRenderer.send('__markbot-hidden-browser-window-loaded', true);
          });
        });
      });
    });
  ...
  setTimeout(function () {
    window.requestAnimationFrame(function () {
      window.requestAnimationFrame(function () {
        window.requestAnimationFrame(function () {
          window.requestAnimationFrame(function () {
            nodeRequire('electron').ipcRenderer.send('__markbot-hidden-browser-window-fonts-loaded', true);
          });
        });
      });
    });
